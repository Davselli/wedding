...
/*------------------------------------------
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2024-06-08 17:00', function(event) {
    ...
    -------------------------------------------*/
    if ($("#clock2").length) {
        $('#clock2').countdown('2024-06-08 17:00', function(event) {
            var $this = $(this).html(event.strftime(''
            + '<div class="box"><div><div class="time">%D</div> <span>Days</span> </div></div>'
            + '<div class="box"><div><div class="time">%H</div> <span>Hours</span> </div></div>'
            + '<div class="box"><div><div class="time">%M</div> <span>Mins</span> </div></div>'));
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    loopingVideo.addEventListener("ended", function () {
        fadeVideo(loopingVideo);
    ...
    function fadeVideo(videoElement) {
        ...
        const fadeInterval = setInterval(function () {
            if (videoElement.style.opacity >= 1) {
                ...
                videoElement.style.opacity = parseFloat(videoElement.style.opacity) + 0.02;
            }
        }, 20);
    }
